          ...
          fromFile('extension/camunda/inputOutput-list.part.bpmn', 'camunda:InputOutput', function (err, result) {
            ...
            var expected = {
              ...
              outputParameters: [{
                ...
                definition: {
                  $type: 'camunda:List',
                  items: [{ $type: 'camunda:Value', value: '${1+1}' }, { $type: 'camunda:Value', value: '${1+2}' }, { $type: 'camunda:Value', value: '${1+3}' }]
                }
              }]
            };
          ...
          fromFile('extension/camunda/inputOutput-mixed.part.bpmn', 'camunda:InputOutput', function (err, result) {
            ...
            var expected = {
              ...
              inputParameters: [{
                ...
                definition: {
                  $type: 'camunda:List',
                  items: [{ $type: 'camunda:Value', value: 'constantStringValue' }, { $type: 'camunda:Value', value: '${ \'elValue\' }' }, {
                    $type: 'camunda:Script',
                    source: '\n            return "scriptValue";\n          '
                  }]
                }
