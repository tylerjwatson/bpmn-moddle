...
describe('bpmn-moddle - read', function () {
    ...
    describe('bpmn', function () {
      ...
      it('SubProcess#flowElements', function (done) {
        ...
        fromFile('test/fixtures/bpmn/sub-process-flow-nodes.part.bpmn', 'bpmn:SubProcess', function (err, result) {
          ...
          var expected = {
            ...
            flowElements: [{ $type: 'bpmn:StartEvent', id: 'StartEvent_1', name: 'Start Event 1' }, { $type: 'bpmn:Task', id: 'Task_1', name: 'Task' }, { $type: 'bpmn:SequenceFlow', id: 'SequenceFlow_1', name: '' }]
          };
      ...
      it('CompensateEventDefinition', function (done) {
        ...
        fromFile('test/fixtures/bpmn/compensate-event-definition.part.bpmn', 'bpmn:CompensateEventDefinition', function (err, result) {
          ...
          (0, _expect2.default)(result.waitForCompletion).to.be.true;
      ...
      it('SubProcess#incoming', function (done) {
        ...
        fromFile('test/fixtures/bpmn/subprocess-flow-nodes-outgoing.part.bpmn', 'bpmn:Process', function (err, result) {
          ...
          (0, _expect2.default)(subProcess.incoming).to.jsonEqual([expectedSequenceFlow]);
          (0, _expect2.default)(subProcess.outgoing).to.jsonEqual([expectedSequenceFlow]);

          (0, _expect2.default)(sequenceFlow.sourceRef).to.jsonEqual(expectedSubProcess);
          (0, _expect2.default)(sequenceFlow.targetRef).to.jsonEqual(expectedSubProcess);
      ...
      it('ThrowEvent#dataInputAssociations', function (done) {
        ...
        fromFile('test/fixtures/bpmn/throw-event-dataInputAssociations.part.bpmn', 'bpmn:EndEvent', function (err, result) {
          ...
          var expected = {
            ...
            dataInputAssociations: [{ $type: 'bpmn:DataInputAssociation', id: 'DataInputAssociation_1' }]
          };
      ...
      it('CatchEvent#dataOutputAssociations', function (done) {
        ...
        fromFile('test/fixtures/bpmn/catch-event-dataOutputAssociations.part.bpmn', 'bpmn:StartEvent', function (err, result) {
          ...
          var expected = {
            ...
            dataOutputAssociations: [{ $type: 'bpmn:DataOutputAssociation', id: 'DataOutputAssociation_1' }]
          };
      ...
      it('Escalation + Error', function (done) {
        ...
        fromFile('test/fixtures/bpmn/escalation-error.bpmn', function (err, result) {
          ...
          (0, _expect2.default)(result).to.jsonEqual({
            ...
            id: 'test',
            targetNamespace: 'http://bpmn.io/schema/bpmn',
            rootElements: [{ $type: 'bpmn:Escalation', id: 'escalation' }, { $type: 'bpmn:Error', id: 'error' }]
          });
        ...
        fromFile('test/fixtures/bpmn/extension-elements.bpmn', function (err, result) {
          ...
          (0, _expect2.default)(result).to.jsonEqual({
            ...
            extensionElements: {
              ...
              values: [{ $type: 'vendor:info', key: 'bgcolor', value: '#ffffff' }, { $type: 'vendor:info', key: 'role', value: '[]' }]
            }
          });
      ...
      it('Category', function (done) {
        ...
        fromFile('test/fixtures/bpmn/category.bpmn', function (err, result) {
          ...
          // then
          (0, _expect2.default)(category).to.jsonEqual({
            $type: 'bpmn:Category',
      ...
      it('Operation#messageRef', function (done) {
        ...
        fromFile('test/fixtures/bpmn/operation-messageRef.bpmn', 'bpmn:Definitions', function (err, result, context) {
          ...
          // then
          (0, _expect2.default)(references).to.jsonEqual([inMessage, outMessage]);
      ...
      it('BPMNEdge#waypoint', function (done) {
        ...
        fromFile('test/fixtures/bpmn/di/bpmnEdge-waypoint.part.bpmn', 'bpmndi:BPMNEdge', function (err, result) {
          ...
          (0, _expect2.default)(result).to.jsonEqual({
            ...
            waypoint: [{ $type: 'dc:Point', x: 4905.0, y: 1545.0 }, { $type: 'dc:Point', x: 4950.0, y: 1545.0 }]
          });
      ...
      it('BPMNEdge#waypoint (explicit xsi:type)', function (done) {
        ...
        fromFile('test/fixtures/bpmn/di/bpmnEdge.part.bpmn', 'bpmndi:BPMNEdge', function (err, result) {
          ...
          var expected = {
            $type: 'bpmndi:BPMNEdge',
            id: 'BPMNEdge_1',
            waypoint: [{ $type: 'dc:Point', x: 388.0, y: 260.0 }, { $type: 'dc:Point', x: 420.0, y: 260.0 }]
          };
  ...
  describe('should import references', function () {
    ...
    it('via elements', function (done) {
      ...
      // given
      var xml = '<bpmn:serviceTask xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL">' + '<bpmn:outgoing>OUT_1</bpmn:outgoing>' + '<bpmn:outgoing>OUT_2</bpmn:outgoing>' + '</bpmn:serviceTask>';
      ...
      read(xml, 'bpmn:ServiceTask', function (err, result, context) {
        ...
        // then
        (0, _expect2.default)(references).to.jsonEqual([reference1, reference2]);
  ...
  describe('should import extensions', function () {
    ...
    it('attributes on root', function (done) {
      ...
      // given
      var xml = '<bpmn:sequenceFlow xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" ' + 'xmlns:foo="http://foobar" foo:bar="BAR" />';

      // when
      read(xml, 'bpmn:SequenceFlow', function (err, result, context) {

        // then
        (0, _expect2.default)(result.$attrs['foo:bar']).to.eql('BAR');
  ...
  describe('should read xml documents', function () {
    ...
    it('simple process', function (done) {
      ...
      fromFile('test/fixtures/bpmn/simple.bpmn', function (err, result) {
        ...
        // then
        (0, _expect2.default)(result.id).to.equal('simple');
  ...
  describe('should handle errors', function () {
    ...
    it('when importing non-bpmn xml', function (done) {
      ...
      fromFile('test/fixtures/bpmn/error/not-bpmn.bpmn', function (err, result, context) {
        ...
        (0, _expect2.default)(err).to.exist;
        (0, _expect2.default)(err.message).to.match(/failed to parse document as <bpmn:Definitions>/);

        (0, _expect2.default)(result).not.to.exist;

        (0, _expect2.default)(warnings).to.have.length(1);
        (0, _expect2.default)(warning.message).to.match(/unparsable content <definitions> detected/);
    ...
    it('when importing bpmn:Extension (missing definition)', function (done) {
      ...
      fromFile('test/fixtures/bpmn/error/extension-definition-missing.bpmn', function (err, result, context) {
        ...
        (0, _expect2.default)(warnings[0].message).to.eql('unresolved reference <ino:tInnovator>');
    ...
    it('when importing invalid categoryValue / reference', function (done) {
      ...
      fromFile('test/fixtures/bpmn/error/categoryValue.bpmn', function (err, result, context) {
        ...
        (0, _expect2.default)(warnings).to.have.length(2);

        var invalidElementWarning = warnings[0];
        var unresolvableReferenceWarning = warnings[1];

        (0, _expect2.default)(invalidElementWarning.message).to.eql('unparsable content <categoryValue> detected\n\t' + 'line: 2\n\t' + 'column: 2\n\t' + 'nested error: unrecognized element <bpmn:categoryValue>');

        (0, _expect2.default)(unresolvableReferenceWarning.message).to.eql('unresolved reference <sid-afd7e63e-916e-4bd0-a9f0-98cbff749193>');
    ...
    it('when importing duplicate ids', function (done) {
      ...
      fromFile('test/fixtures/bpmn/error/duplicate-ids.bpmn', function (err, result, context) {
        ...
        (0, _expect2.default)(err).not.to.exist;
        (0, _expect2.default)(warnings).to.have.length(1);
        (0, _expect2.default)(warnings[0].message).to.contain('duplicate ID <test>');
    ...
    it('when importing broken diagram / xmlns redeclaration', function (done) {
      ...
      fromFile('test/fixtures/bpmn/error/xmlns-redeclaration.bpmn', function (err, result, context) {
        ...
        (0, _expect2.default)(context.warnings).to.have.length(2);
        (0, _expect2.default)(context.warnings[0].message).to.match(/attribute <xmlns> already defined/);
        (0, _expect2.default)(context.warnings[1].message).to.match(/attribute <id> already defined/);

        (0, _expect2.default)(result.$attrs.xmlns).to.eql('http://www.omg.org/spec/BPMN/20100524/MODEL');
        (0, _expect2.default)(result.id).to.eql('10');
    ...
    it('when importing invalid attributes', function (done) {
      ...
      fromFile('test/fixtures/bpmn/error/invalid-attributes.bpmn', function (err, result, context) {
        ...
        (0, _expect2.default)(context.warnings).to.have.length(2);
        (0, _expect2.default)(context.warnings[0].message).to.match(/illegal first char attribute name/);
        (0, _expect2.default)(context.warnings[1].message).to.match(/missing attribute value/);

        (0, _expect2.default)(result.rootElements).to.jsonEqual([{
          $type: 'bpmn:Process',
          id: 'Process_1'
        }]);
  ...
  describe('should read attributes', function () {
    ...
    it('when importing non-xml text', function (done) {
      ...
      fromFile('test/fixtures/bpmn/attrs.bpmn', function (err, result, context) {
        ...
        (0, _expect2.default)(warnings[0].message).to.match(/illegal first char attribute name/);
